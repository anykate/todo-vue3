...
<template>
    ...
    <div
        class="flex flex-col justify-between space-y-4 mb-4 md:flex-row md:mx-3 md:space-y-0 md:space-x-4 md:mb-0"
    >
                    ...
                    <template #card-title>
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-8">
                                <button
                                    class="space-x-2 text-red-600 text-2xl"
                                    title="Delete ToDo"
                                    @click="delToDo(index)"
                                >
                                    &times;
                                ...
                                <button
                                    ...
                                    class="space-x-2 text-green-600 text-2xl"
                                    title="Mark as completed"
                                    @click="changeCompletedStatus(index)"
                                >
                                    &check;
                                </button>
                                <button
                                    v-else
                                    class="space-x-2 text-orange-600 text-2xl"
